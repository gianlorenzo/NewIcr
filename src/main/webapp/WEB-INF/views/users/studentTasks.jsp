...
<table>
    ...
    <c:choose>
        <c:when test="${s.tempoEffettuato/(s.taskEffettuati+1.) > 80}">
            <tr>
                <th><c:out
                        value="${((s.tempoEffettuato - s.tempoEffettuato%3600)/3600).intValue()}:${((s.tempoEffettuato%3600 - s.tempoEffettuato%3600%60)/60).intValue()}:${s.tempoEffettuato%3600%60}"></c:out></th>
            </tr>
        </c:when>
        <c:when test="${s.tempoEffettuato/(s.taskEffettuati+1.) <= 80}">
            <tr>
